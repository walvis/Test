DROP FUNCTION IF EXISTS walvis_upsert_mission(int[], text[]);
...
--  inserted: 1
--
CREATE OR REPLACE FUNCTION walvis_upsert_mission(
  cartodb_ids integer[],
  geojsons text[])
...
GRANT EXECUTE ON FUNCTION walvis_upsert_mission(integer[],text[]) TO publicuser;